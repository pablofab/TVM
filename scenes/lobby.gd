...
@onready var credits:Button = $PanelContainer/Menus/StartMenu/HBoxContainer2/Credits
@onready var exit:Button = $PanelContainer/Menus/StartMenu/HBoxContainer3/Exit
@onready var howtoplay:Button = $PanelContainer/Menus/StartMenu/HBoxContainer2/howtoplay
@onready var ip = %IP
